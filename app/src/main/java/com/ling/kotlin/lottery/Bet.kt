...
//import com.ling.kotlin.lottery.bean.MenuDetailEntity
...
//    val menus = MutableLiveData<List<MenuDetailEntity>>()
...
//        lotteryId = bundle?.getInt("lotteryId",0)!!
//        getLotteryEntitys()
...
//        if (bet_drawer_layout.isDrawerOpen(GravityCompat.START)) bet_drawer_layout.closeDrawer(GravityCompat.START) else bet_drawer_layout.openDrawer(
//            GravityCompat.START)
//    }
...
//
//                Log.e("AreaFragment","AreaFragment== ${menus[0].menuName}" )
//            })
//        }
//    }
//}
//
//
//class ChatFragment(override val layoutId: Int=R.layout.lottery_chat_layout):BaseFragment() {
//    override fun initView(v: View) {
//
//    }
//}